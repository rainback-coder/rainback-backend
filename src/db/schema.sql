...
CREATE TABLE menu_dishes (
  ...
  name            TEXT NOT NULL,
  description     TEXT,
  category        TEXT DEFAULT 'Main' CHECK (category IN ('Starter','Main','Side','Dessert','Drink','Pasta','Pizza')),
  price           NUMERIC(8,2),
  -- Nutrition
...
-- ── MEMBER MEALS ───────────────────────────────────────
-- Dishes a member logs after a visit (manual for now; later auto via POS).
